...
void Game2(){
	...
	transmitGameState();
	receivedGameState = 0;
	while(!(receivedGameState==20 || receivedGameState==25)/*receivedGameState<20 || receivedGameState>25*/){ //wait until a partner is doing Game2
		displayLEDs(LEDs);
